...
r = requests.get(QUERY_URL + 'function=INFLATION_EXPECTATION&datatype=json&apikey=' + args.apikey, timeout=5)
if r.status_code != 200:
    exit(1)
with open(args.output + '/inflation_expectation.json', 'w') as fd:
    fd.write(r.text)
