...
r = requests.get(QUERY_URL + 'function=REAL_GDP_PER_CAPITA&datatype=json&apikey=' + args.apikey, timeout=5)
if r.status_code != 200:
    exit(1)
with open(args.output + '/real_gdp_per_capita.json', 'w') as fd:
    fd.write(r.text)
