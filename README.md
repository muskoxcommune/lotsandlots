...
```
### Step 3:
After the program initializes, a browser should open and redirect you to ETrade's authorization page.
...
```
Restart the program to reload the updated config. This completes program setup.

## API Documentation
This program uses https://swagger.io/ for API documentation. You can load the Swagger UI by going to `http://localhost:5000` in a browser.
